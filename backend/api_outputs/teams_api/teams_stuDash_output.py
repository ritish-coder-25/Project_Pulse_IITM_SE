...
class StuDashTeamSchema(Schema):
    user_name=fields.String(required=True,description="Name of the student")
    ...
    total_max_marks = fields.Float(required=True, description="Maximum marks for the project")
